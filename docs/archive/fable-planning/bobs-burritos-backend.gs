...
var OWNER_EMAIL = 'you@example.com';                     // <-- change me
...
function insertOrder(data) {
  ...
  MailApp.sendEmail({
    ...
    body:
      ...
      'TOTAL: $' + data.total + '\n\n' +
      'Payment status updates happen via the kitchen portal or the reconciler — do not edit the sheet by hand.'
  });
...
function setupSheets() {
  ...
  prep.clear();
  var rows = [
    ['BOB\'S BURRITOS — PREP SHEET (read-only mirror; the portal is the primary view)', ''],
